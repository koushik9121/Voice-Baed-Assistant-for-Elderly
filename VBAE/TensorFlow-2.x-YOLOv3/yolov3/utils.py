...
def draw_bbox(image, bboxes, input_labels, CLASSES=YOLO_COCO_CLASSES, show_label=True, show_confidence = True, Text_colors=(255,255,0), rectangle_colors='', tracking=False):   
    ...
    for i, bbox in enumerate(bboxes):
        ...
        print("Final:   ",NUM_CLASS[class_ind], score)     
        ...
        if(NUM_CLASS[class_ind] in input_labels and score > 0.45):
            cv2.rectangle(image, (x1, y1), (x2, y2), bbox_color, bbox_thick*2)
            coords.append([x1,x2,y1,y2])
            outputs.append(NUM_CLASS[class_ind])
...
def detect_image(Yolo, image_path, output_path, input_labels, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors=''):
    ...
    image,coords, outputs = draw_bbox(original_image, bboxes,input_labels,CLASSES=CLASSES, rectangle_colors=rectangle_colors)
    ...
    #return image
    return image,coords, image.shape[0], image.shape[1], outputs
